...
#-----------------------------------------------------------------------
		...
		Particle_distribution_file = generate_initial_dispersion_vector_distribution(1E-3, p, Lattice, output_file='input/ParticleDistribution.in', summary_file='input/ParticleDistribution_summary.txt')

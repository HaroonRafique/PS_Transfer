...
if not rank:
	if os.path.exists('PTC-PyORBIT_flat_file.flt'):
		...
		os.system("/afs/cern.ch/eng/sl/MAD-X/pro/releases/5.02.00/madx-linux64 < 02_originl_lattice_optimised_matching.madx")
orbit_mpi.MPI_Barrier(comm)
...
# Create the initial distribution 
		...
		if s['Mismatch']:
			print '\n\n\tgenerate_initial_distribution_dispersion_mismatch'

...
def generate_initial_distribution_synch_particle_manual_Twiss(parameters, TwissDict, matfile=0, output_file='ParticleDistribution.in', outputFormat='pyOrbit', summary_file='ParticleDistribution_summary.txt', summary_mat_file=None):
...
def generate_initial_distribution_manual_Twiss(parameters, TwissDict, output_file = 'Input/ParticleDistribution.in', summary_file = 'Input/ParticleDistribution_summary.txt', outputFormat='Orbit'):
	...
	print '\n\t\tgenerate_initial_distribution_manual_Twiss::dispersionx = ', dispersionx 
...
def generate_initial_distribution_3DGaussian_manual_Twiss(parameters, TwissDict, output_file = 'Input/ParticleDistribution.in', summary_file = 'Input/ParticleDistribution_summary.txt', outputFormat='Orbit'):
	...
	print '\n\t\tgenerate_initial_distribution_3DGaussian_manual_Twiss::dispersionx = ', dispersionx 
	...
	if orbit_mpi.MPI_Comm_rank(orbit_mpi.mpi_comm.MPI_COMM_WORLD) == 0:
		...
		parameter_list = ['circumference', 'rf_voltage', 'phi_s', 'harmonic_number', 'gamma_transition', 'n_macroparticles', 'energy', 'gamma', 'bunch_length', 'x0', 'xp0', 'betax0', 'alphax0', 'etax0', 'etapx0', 'y0', 'yp0', 'betay0', 'alphay0', 'etay0', 'etapy0', 'epsn_x', 'epsn_y', 'TransverseCut']
...
def generate_initial_x_distribution(n_sigma, parameters, Lattice,output_file = 'Input/ParticleDistribution.in', summary_file = 'Input/ParticleDistribution_summary.txt', outputFormat='Orbit'):
	...
	if orbit_mpi.MPI_Comm_rank(comm) == 0:
		with open(output_file,"w") as fid:
			...
			for i in range(parameters['n_macroparticles']):
				x[i] = closedOrbitx['x0'] - n_sigma + i * float(2*n_sigma/float(parameters['n_macroparticles'])) * np.sqrt(float(parameters['betax0']) * ( parameters['epsn_x'] / (parameters['beta'] * parameters['gamma'])))
				xp[i] = closedOrbitx['xp0']
				y[i] = closedOrbity['y0']
				yp[i] = closedOrbity['yp0']
				phi[i] = 0.
